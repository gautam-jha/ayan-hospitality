    ...
    return (
      ...
      >
        ...
        <p className="text-cream-200/90 text-base max-w-md mx-auto leading-relaxed">
          We have received your enquiry{city ? ` for ${city}` : ''}. Our wedding hospitality team will get back to you within 24 hours to schedule your free consultation.
        </p>
        <button
          onClick={() => {
            setStatus('idle');
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
        <div>
          <label htmlFor="hp-name" className="sr-only">Your name *</label>
          <input
            id="hp-name"
            type="text"
            name="name"
        ...
        <div>
          <label htmlFor="hp-phone" className="sr-only">Phone / WhatsApp number *</label>
          <input
            id="hp-phone"
            type="tel"
            name="phone"
        ...
        <div>
          <label htmlFor="hp-city" className="sr-only">Wedding city / venue</label>
          <input
            id="hp-city"
            type="text"
            name="city"
        ...
        <div>
          <label htmlFor="hp-guests" className="sr-only">Approx. guest count</label>
          <input
            id="hp-guests"
            type="text"
            name="guestCount"
