...
export function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-40 flex items-center gap-2 bg-whatsapp text-white rounded-full shadow-gold px-4 py-3 lg:px-5 lg:py-3.5 hover:brightness-110 active:scale-95 transition-all duration-200 group"
    >
