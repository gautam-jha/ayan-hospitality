...
export const HOSPITALITY_SERVICES: Service[] = [
  {
    ...
    included: [
      ...
      "RSVP tracking dashboard shared with the host family",
      "Guest dietary and accessibility requirement collection",
      "Reminder outreach for pending RSVPs",
      "Final attendance confirmation and headcount reports",
      "Integration with seating and F&B planning",
    ],
    timelineNote:
      "Starts 4–8 weeks before the event. Final headcounts locked 5 days prior.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Bilingual (English + Hindi) staff",
      "Real-time query resolution and escalation protocol",
      "Coordination with hotel front desk and event operations",
      "WhatsApp support channel for guests",
      "Post-event feedback collection",
    ],
    timelineNote:
      "Activated 48 hours before the first event, stays live until the last guest checks out.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Airport-to-hotel-to-venue accompaniment",
      "Priority check-in coordination with hotel",
      "Suite / room preference pre-arrangement",
      "Special dietary and mobility accommodation",
      "Discreet, professional conduct at all times",
    ],
    timelineNote:
      "VIP profiles and preferences confirmed 2 weeks before arrival. Escorts briefed 48 hours prior.",
    whatsappMessage:
      "Hi Ayan Hospitality, I need VIP Guest Handling & Escort Services for my wedding. Can we discuss?",
    metaTitle: "VIP Guest Handling & Escort Services | Ayan Hospitality",
    metaDescription:
      "Personal escort services for VIP and senior guests at Indian weddings. Dedicated staff, airport-to-venue accompaniment, and the highest standard of hospitality.",
  },
  {
    slug: "ritual-coordination",
    pillar: "hospitality",
    ...
    included: [
      ...
      "Guest seating and flow management for each ceremony",
  ...
  },
  {
    ...
    included: [
      ...
      "Green room and hospitality setup",
      "Sound and lighting cue coordination",
      "On-time arrival and payment coordination support",
      "Backup contingency if artist delays occur",
      "Guest flow management during performances",
    ],
    timelineNote:
      "Artist coordination plan shared 72 hours before event. On-ground team in place 3 hours before performances.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Stage, décor, and AV installation supervision",
      "Venue walk-through and readiness checks",
      "Safety and fire-exit compliance checks",
      "Real-time issue escalation with vendor leads",
      "Post-event breakdown and venue handover coordination",
    ],
    timelineNote:
      "Setup supervision begins the day before the event. A production manager is present through breakdown.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Live counter and buffet management",
      "Bar setup and service coordination",
      "Dietary and allergy accommodation tracking",
      "Real-time replenishment and wastage management",
      "Post-meal clearance and venue reset",
    ],
    timelineNote:
      "F&B plan finalized 1 week before. Team in place 2 hours before service opens.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Supplier and packaging quality checks",
      "Guest-wise personalization (name tags, notes)",
      "In-room placement before guest check-in",
      "Event-wise giveaway distribution management",
      "Inventory reconciliation and leftover coordination",
    ],
    timelineNote:
      "Hamper brief confirmed 3 weeks before. Placement done 24 hours before guest check-in.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Content review and proofing support",
      "Print quality and colour accuracy checks",
      "On-site placement of all collaterals",
      "Last-minute reprint coordination if needed",
      "Signage placement and wayfinding setup",
    ],
    timelineNote:
      "Print-ready files locked 2 weeks before. Placement on the day of each event.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Basic medical supplies and first-responder protocols",
      "Essentials kit: pain relief, antacids, safety pins, band-aids, stain removers, sewing kit",
      "Emergency escalation protocol (nearest hospital, ambulance contact)",
      "Sanitary supplies station for women guests",
      "Coordination with hotel medical team if available",
    ],
    timelineNote:
      "First-aid station set up 2 hours before each event. Staffed through breakdown.",
    whatsappMessage:
      "Hi Ayan Hospitality, I'd like to include a First Aid & Essentials Kit for my wedding. Can we discuss?",
    metaTitle: "Wedding First Aid & Guest Essentials Kit | Ayan Hospitality",
    metaDescription:
      "Staffed first-aid station and comprehensive essentials kit for multi-day Indian weddings. Your guests are cared for; you focus on the celebrations.",
  },
];

export const LOGISTICS_SERVICES: Service[] = [
  {
    ...
    included: [
      ...
      "Flight and train delay tracking with real-time adjustments",
      "Driver briefings with name boards and guest details",
      "WhatsApp updates to guests on driver arrival",
      "Airport/station coordinator on the ground",
      "Departure transfers with check-out coordination",
    ],
    timelineNote:
      "Transfer schedule finalized 5 days before. Coordinators deployed from first arrival window.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Baraat and procession route planning",
      "Vintage and specialty vehicle coordination",
      "Driver briefings with event timeline",
      "Decorated vehicle coordination with décor team",
      "Backup vehicle on standby",
    ],
    timelineNote:
      "Vehicle lineup confirmed 1 week before. Route recce completed 48 hours prior.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Arrival luggage collection and room delivery",
      "Secure luggage holding area management",
      "Departure luggage collection and airport dispatch",
      "Lost/delayed luggage follow-up coordination",
      "Porter briefings and team management",
    ],
    timelineNote:
      "Tags printed and distributed at the airport/station on arrival day. Departure service begins 3 hours before check-out.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Inter-city charter coordination (buses, trains, flights)",
      "Equipment and décor logistics across venues",
      "En-route guest support coordinators",
      "Contingency planning for transport delays",
      "Real-time guest movement tracking dashboard",
    ],
    timelineNote:
      "Logistics plan locked 3 weeks before. Daily briefings during the event period.",
    whatsappMessage:
      "Hi Ayan Hospitality, I need Multi-city Logistics planning for my wedding. Can we discuss?",
    metaTitle: "Multi-city Wedding Logistics Management India | Ayan Hospitality",
    metaDescription:
      "Expert multi-city and multi-modal logistics for destination weddings across India. We coordinate every transfer, charter, and movement so nothing is left to chance.",
  },
  {
    slug: "event-supervisors",
    pillar: "logistics",
    ...
    timelineNote:
      "Supervisors deployed from venue setup through post-event handover.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Full-event accompaniment from arrival to departure",
      "Mobility, language, and dietary assistance",
      "Medication and schedule reminders if required",
      "Discreet professional conduct",
      "24-hour availability for assigned guests",
    ],
    timelineNote:
      "Shadow assignments confirmed 1 week before. Briefing with assigned guest on Day 1.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Material, prop, and message relay",
      "Emergency supply runs (backstage, medical, F&B)",
      "Stationery and collateral distribution support",
      "Crowd flow and crowd direction assistance",
      "Vendor coordination relay",
    ],
    timelineNote:
      "Runners briefed 2 hours before each event. Ratio: 1 runner per 50 guests recommended.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Airport, railway, and venue luggage handling",
      "Equipment and décor loading/unloading",
      "In-room luggage delivery and collection",
      "Fragile item and gift handling protocols",
      "Coordination with hotel porter team",
    ],
    timelineNote:
      "Porter team deployed on arrival day and departure day. Additional shifts for equipment movement.",
    whatsappMessage:
  ...
  },
  {
    ...
    included: [
      ...
      "Item-wise tracking through procurement, storage, and deployment",
      "Daily inventory reconciliation reports",
      "Vendor return and handover management",
      "Damaged/missing item documentation and resolution",
      "Digital inventory log shared with the host family",
    ],
    timelineNote:
      "Inventory register created 2 weeks before. Daily reconciliation through post-event wrap.",
    whatsappMessage:
